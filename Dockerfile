...
RUN apt-get install -qy php8-mysql
RUN apt-get install -qy php8-mysqlnd


# Install proxy Dependencies
RUN \
  apt-get update -q && \
  apt-get install -qy apache2 php8 php8-common curl libcurl3 php8-curl libapache2-mod-php8 php-xml-parser php8-gd php8-sqlite php8-mcrypt php8-tidy php8-cli   php8-mysql inotify-tools libapache2-mod-proxy-html && \
  apt-get clean -y && \
